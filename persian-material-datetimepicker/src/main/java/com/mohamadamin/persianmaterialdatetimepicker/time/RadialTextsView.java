...
public class RadialTextsView extends View {
    ...
    public void initialize(Resources res, String[] texts, String[] innerTexts,
        ...
        mTypefaceLight = Typeface.createFromAsset(mContext.getAssets(), "fonts/IRANSans(FaNum)_Light.ttf");
        mTypefaceRegular = Typeface.createFromAsset(mContext.getAssets(), "fonts/font.ttf");
