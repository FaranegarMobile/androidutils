...
//
    ...
    public DayPickerView(Context context, DatePickerController controller, ColorModel model) {
        super(context);
        init(context);
        setController(controller, model);
    }

    public void setController(DatePickerController controller, ColorModel model) {
    ...
    protected void refreshAdapter() {
        if (mAdapter == null) {
            mAdapter = createMonthAdapter(getContext(), mController, model);
        } else {
    ...
    public abstract MonthAdapter createMonthAdapter(Context context,
            DatePickerController controller, ColorModel model);
