...
public abstract class MonthView extends View {
    ...
    public MonthView(Context context, AttributeSet attr, DatePickerController controller , ColorModel model) {
        super(context, attr);
...
//        boolean darkTheme = mController != null && mController.isThemeDark();
        ...
        if (model != null){
            mDayTextColor = (model.getMonthName());
            mMonthDayTextColor =(model.getDayOfWeekName());
            mDisabledDayTextColor = (model.getPastDayColor());
            mHighlightedDayTextColor = (model.getMonthName());
            mSelectedDayTextColor = (model.getSelectedDay());
            mMonthTitleColor = (model.getMonthName());
            mTodayNumberColor = (model.getTodayBackColor());
            darkTheme = model.isDark();
        }else {
            ...
            mTodayNumberColor = res.getColor(R.color.dideban_color);
            darkTheme = false;
        }
        /*
        if (darkTheme) {
       ...
       /* if (DatePickerDialog.appTagDate)
            mTodayNumberColor = res.getColor(R.color.alibaba_color);
        else
            mTodayNumberColor = res.getColor(R.color.dideban_color);
*/
//        mMonthTitleColor = res.getColor(R.color.mdtp_white);
    ...
    protected void initView() {
        ...
        mMonthTitlePaint.setTypeface(Typeface.createFromAsset(getContext().getAssets(), "fonts/font.ttf"));
