...
public class SimpleMonthView extends MonthView {
    ...
    public SimpleMonthView(Context context, AttributeSet attr, DatePickerController controller , ColorModel model) {
        super(context, attr, controller , model);
    }
    ...
    public void drawMonthDay(Canvas canvas, int year, int month, int day,
        ...
        if(isHighlighted(year, month, day)) {
            mMonthNumPaint.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/font.ttf"));
        }
        else {
            mMonthNumPaint.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/font.ttf"));
        }
